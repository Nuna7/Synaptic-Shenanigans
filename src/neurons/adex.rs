...
impl AdExProfile {
    pub fn params(self) -> AdExParams {
        ...
        match self {
            ...
            Self::FastSpiking    => AdExParams { a:  0.0, b:   0.0, tau_w: 10.0, delta_t: 0.5, c_m: 100.0, ..base },
...
impl NeuronPopulation for AdExPopulation {
    ...
    fn get_threshold(&self, idx: usize) -> f32  { self.v_t[idx].load() }
    fn set_threshold(&self, idx: usize, v: f32) { if idx < self.n { self.v_t[idx].store(v); } }
